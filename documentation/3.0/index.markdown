...
What's Next?
---
Once you've read this Getting Started guide, you'll want to move on to the [Developing Applications Manual](/documentation/3.0/developing-applications) and when you need to look things up, use the [Reference Manual](/documentation/3.0/reference-manual/). You may also want to learn about [Using Subsystems](/documentation/3.0/using-subsystems.html) which allows FW/1 applications to be combined as modules of a larger FW/1 application, or [DI/1](/documentation/3.0/using-di-one.html), a simple, convention-based dependency injection framework.
